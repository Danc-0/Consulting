...
public class LoginActivity extends AppCompatActivity {
    ...
    Button mLogIn;
    TextView register, forgot_password, resend_verification_link;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        resend_verification_link = findViewById(R.id.verification_link);
    ...
    private void init(){
        ...
        TextView resendEmailVerification = (TextView) findViewById(R.id.verification_link);
